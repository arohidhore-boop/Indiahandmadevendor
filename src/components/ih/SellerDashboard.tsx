...
import { useIH, type Product } from "@/lib/ih-store";
...
export function SellerDashboard() {
  const { seller, products, onboarding } = useIH();
    ...
    <>
        ...
        {isLive ? (
          ...
          <>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3">
              {firstProduct && (
                <Link to="/products" className="ih-btn ih-btn-primary">
                  <Eye className="h-4 w-4" /> View submitted product
                </Link>
              )}
              <Link to="/add-product" className="ih-btn ih-btn-outline">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="surface-card p-6 flex flex-col">
          ...
          <Link to="/profile" className="ih-btn ih-btn-ghost mt-4 text-[var(--primary)] -ml-2">
