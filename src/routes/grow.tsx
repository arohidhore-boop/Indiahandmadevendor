...
function Grow() {
  return (
    <AppShell>
      <div>
        <h1 className="font-serif text-[28px] leading-[32px]">Grow your shop</h1>
        ...
        {cards.map((c) => {
          ...
          return (
            <article key={c.title} className="surface-card p-6 flex flex-col hover-lift">
              ...
              <span className="mt-4 text-[11px] leading-[16px] tracking-[0.5px] text-[var(--accent)] font-medium">{c.tag}</span>
              <h3 className="font-serif text-[20px] leading-[24px] font-medium mt-1 leading-tight">{c.title}</h3>
