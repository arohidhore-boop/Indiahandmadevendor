...
function Landing() {
  return (
    <div className="min-h-screen flex flex-col bg-[var(--cream)]">
      <GovBar />
      <header className="h-[72px] bg-white border-b border-[var(--border)] flex items-center justify-between px-6 lg:px-10 sticky top-0 z-30">
        <BrandMark />
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/signup"
            className="ih-btn ih-btn-primary hidden sm:inline-flex"
          >
            Start selling
          </Link>
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-6 lg:px-10 py-16 lg:py-20 grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
            <div className="animate-fade-up">
              ...
              <p className="mt-5 text-lg text-[var(--muted-foreground)] max-w-[520px]">
                Sell directly to customers. No middlemen. No commission.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  to="/signup"
                  className="ih-btn ih-btn-primary hover-lift"
                >
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={t} className="surface-card p-6 hover-lift">
                ...
                <h3 className="font-serif text-xl leading-snug">{t}</h3>
                <p className="text-sm text-[var(--muted-foreground)] mt-2 leading-relaxed">{d}</p>
              </div>
            ))}
          </div>
          </div>
              ...
              {[
                {
                  ...
                  d: "Sign up in minutes with your phone number and basic details.",
                },
                {
                  n: "02",
                  t: "List your products",
                  d: "Add photos, set your price, and tell the story behind each piece.",
                },
                {
                  n: "03",
                  t: "Start receiving orders",
                  d: "Get paid directly to your bank account as orders come in.",
                },
              ].map(({ n, t, d }) => (
                <div
                  key={n}
                ...
                >
                  <div className="font-serif text-3xl text-[var(--primary)]/40 shrink-0">
                    {n}
                  </div>
                  <div>
            ...
            {[
              {
                ...
                q: "Now I have a space to show case and sell my work online and I don't have to maintain my own website.",
              },
              {
                img: artisanPotter,
                name: "Mohammad Irfan",
              ...
              },
              {
                ...
                q: "I’ve tried other e-commerce websites, but the 33% commission really eats into our profits. Free shipping and zero commission have been a blessing for the Sakhi collective.",
              },
            ].map((p) => (
              <figure key={p.name} className="surface-card overflow-hidden hover-lift">
                ...
                <figcaption className="p-6">
                  <blockquote className="font-serif text-lg leading-snug text-[var(--foreground)]">
                    “{p.q}”
                  </blockquote>
                  <div className="mt-4 text-sm">
                    <div className="font-medium">{p.name}</div>
                    <div className="text-[var(--muted-foreground)]">{p.craft}</div>
                  </div>
                </figcaption>
              </figure>
            ))}
        ...
        <section id="categories">
          <div className="max-w-[1200px] mx-auto px-6 lg:px-10 py-20">
            <div className="max-w-[680px]">
              <h2 className="font-serif text-4xl lg:text-5xl leading-[1.1]">What you can sell</h2>
              <p className="mt-4 text-[var(--muted-foreground)]">
              ...
              {[
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/65 to-transparent p-4">
                    <div className="text-white font-serif text-xl">{c.t}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <ul key={i} className="space-y-3 text-sm text-white/80">
                  {col.map((link) => (
                    <li key={link}>
